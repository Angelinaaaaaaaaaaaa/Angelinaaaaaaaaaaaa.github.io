...
date: 2018 - 2020
link: https://Angelinaaaaaaaaaaaa.github.io/
...
tags: ['Artificial intelligence', 'Hardware devices', 'Plants recognition', 'AI Labelling web platform']
stack: ['Python', 'Django', 'React', 'Rancher', 'Kubernetes', 'OVH', 'GCP', 'Docker', 'PostgreSQL', 'MongoDB']
---
